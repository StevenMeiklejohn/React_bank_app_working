...
/***/ function(module, exports, __webpack_require__) {
	...
	var AccountList = __webpack_require__(161);
	var TotalDisplay = __webpack_require__(162);
	var accounts = __webpack_require__(163);
	...
	var BankBox = React.createClass({
	  ...
	  getAccountsTotal: function getAccountsTotal(accounts) {
	    var total = 0;
	  ...
	  getPersonalAccounts: function getPersonalAccounts() {
	    ...
	    try {
	      for (var _iterator2 = this.state.allAccounts[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	  ...
	  getBusinessAccounts: function getBusinessAccounts() {
	    ...
	    try {
	      for (var _iterator3 = this.state.allAccounts[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'h4',
	        null,
	        this.getAccountsTotal(this.state.allAccounts)
	      ),
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'h2',
	        null,
	        this.props.accountsType[0].type
	      ),
	      React.createElement(
	        'h4',
	        null,
	        'Total: £',
	        this.props.accounts_total
	      ),
	      allAccounts
	    );
	  }
